...
In BookManager-labels_en.properties:
BookManager=My application
BookManager[description]=My application does this and that

In BookManager-messages_en.properties:
